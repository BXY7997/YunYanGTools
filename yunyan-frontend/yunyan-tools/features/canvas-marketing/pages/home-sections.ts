...
import type { HomeSectionTone } from "@canvas/components/home/HomeSectionShell";
...
const Sponsors = lazy(async () => {
  const module = await import("@canvas/components/Sponsors");
  return { default: module.Sponsors };
});
const Services = lazy(async () => {
  const module = await import("@canvas/components/Services");
  return { default: module.Services };
});
const Features = lazy(async () => {
  const module = await import("@canvas/components/Features");
  return { default: module.Features };
});
const Testimonials = lazy(async () => {
  const module = await import("@canvas/components/Testimonials");
  return { default: module.Testimonials };
});
const About = lazy(async () => {
  const module = await import("@canvas/components/About");
  return { default: module.About };
});
const Pricing = lazy(async () => {
  const module = await import("@canvas/components/Pricing");
  return { default: module.Pricing };
});
const FAQ = lazy(async () => {
  const module = await import("@canvas/components/FAQ");
  return { default: module.FAQ };
});
const HowItWorks = lazy(async () => {
  const module = await import("@canvas/components/HowItWorks");
  return { default: module.HowItWorks };
});
const Cta = lazy(async () => {
  const module = await import("@canvas/components/Cta");
