...
const featureList: FeatureItem[] = [
  ...
  { title: "数据流图", href: "/diagram/data-flow", description: "分析系统中数据流向", icon: <ArrowRightLeft className="w-4 h-4" /> },
  { title: "活动图", href: "/diagram/activity", description: "详尽的工作流控制逻辑", icon: <Activity className="w-4 h-4" /> },
  { title: "甘特图", href: "/diagram/gantt", description: "项目进度管理与跟踪", icon: <GanttChart className="w-4 h-4" /> },
  { title: "饼图", href: "/diagram/pie", description: "数据比例可视化分析", icon: <PieChart className="w-4 h-4" /> },
  { title: "对象图", href: "/diagram/object", description: "实时的对象实例关系", icon: <Shapes className="w-4 h-4" /> },
  { title: "构件图", href: "/diagram/component", description: "软件系统物理构件组织", icon: <Puzzle className="w-4 h-4" /> },
  { title: "用例图", href: "/diagram/use-case", description: "用户与系统功能交互", icon: <UserCircle className="w-4 h-4" /> },
  { title: "AI专业风格图", href: "/diagram/ai-pro", description: "AI 赋能的高级感图表", icon: <Sparkles className="w-4 h-4" /> },
