...
const featureConfig: Record<string, { title: string; description: string; icon: any }> = {
  ...
  "data-flow": { title: "数据流图", description: "分析系统中数据的流入、处理和流出过程。确保数据合规与安全。", icon: ArrowRightLeft },
  "activity": { title: "活动图", description: "深入展示工作流的控制逻辑与分支路径。比流程图更具技术细节。", icon: Activity },
  "gantt": { title: "甘特图", description: "专业的项目进度管理工具，确保按时交付。支持关键路径分析。", icon: GanttChart },
  "pie": { title: "饼图", description: "简单直观的数据比例可视化分析工具。适合仪表盘展示。", icon: PieChart },
  "object": { title: "对象图", description: "展示系统在特定时间点的对象实例及其关系。用于调试与快照分析。", icon: Shapes },
  "component": { title: "构件图", description: "展示软件构件的物理组织形式及依赖关系。模块化设计的蓝图。", icon: Puzzle },
  "use-case": { title: "用例图", description: "定义用户需求与系统功能之间的交互场景。以用户为中心的设计起点。", icon: UserCircle },
  "ai-pro": { title: "AI专业风格图", description: "利用 AI 生成具有专业设计师水准的高端图表。一键美化，告别丑陋图表。", icon: Sparkles },
  "ai-modern": { title: "AI现代风格图", description: "极简主义风格，自动美化，让您的表达更具冲击力。适合演示文稿。", icon: Zap },
};

export const DiagramFeaturePage = () => {
